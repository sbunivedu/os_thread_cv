...
volatile int use_ptr  = 0;
volatile int fill_ptr = 0;
volatile int num_full = 0;
...
void *consumer(void *threadid) {
  ...
  printf("consumer thread %ld is done.\n", tid);
  return NULL;
}
...
/*
gcc -o pc_single_cv pc_single_cv.c -pthread
./pc_single_cv 10 20 5
*/
